...
public class TestCmdTransports {
    ...
    @Test(expectedExceptions = ParameterException.class, expectedExceptionsMessageRegExp = "Transport archive not "
            + "specfied")
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp =
            "Transport Archive file /tmp/foo.jar" +
                    " does not exist")
    ...
    public void testCmdTransportConfigFile(TransportConfig testTransportConfig, TransportConfig expectedTransportConfig)
            throws Exception {
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Transport Archive "
            + "file /tmp/foo.jar does not exist")
    ...
    public void testCliOverwriteConfigFile() throws Exception {
        ...
        testTransportConfig.setConfigs(createTransport.parseConfigs(
                "{\"created_at-prime\":\"Mon Jul 02 00:33:15 +0000 2018\", \"otherConfigProperties\":{\"property1"
                        + ".value\":\"value1\",\"property2.value\":\"value2\"}}"));
    ...
    @Test(expectedExceptions = RuntimeException.class, expectedExceptionsMessageRegExp = "You must specify a name for"
            + " the transport")
    ...
    public void testUpdateTransport() throws Exception {
        ...
        verify(transports).updateTransport(eq(TransportConfig.builder()
                ...
                .build()), eq(updateTransport.archive), eq(new UpdateOptionsImpl()));
