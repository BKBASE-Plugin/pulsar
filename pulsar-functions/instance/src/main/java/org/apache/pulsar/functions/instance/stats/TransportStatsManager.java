...
public class TransportStatsManager extends ComponentStatsManager {

    public static final String PULSAR_TRANSPORT_METRICS_PREFIX = "pulsar_transport_";
    ...
    // windowed metrics
    private final Counter statTotalProcessedSuccessfully1min;

    private final Counter statTotalRecordsReceived1min;

    private final Counter statTotalUserExceptions1min;

    private final Summary statProcessLatency1min;
    ...
    public TransportStatsManager(FunctionCollectorRegistry collectorRegistry, String[] metricsLabels, ScheduledExecutorService
            scheduledExecutorService) {
        super(collectorRegistry, metricsLabels, scheduledExecutorService);

        statTotalProcessedSuccessfully = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + PROCESSED_SUCCESSFULLY_TOTAL)
        ...
        statTotalRecordsReceived = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + RECEIVED_TOTAL)
        ...
        statTotalSysExceptions = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + SYSTEM_EXCEPTIONS_TOTAL)
        ...
        statTotalUserExceptions = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + USER_EXCEPTIONS_TOTAL)
        ...
        statProcessLatency = Summary.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + PROCESS_LATENCY_MS)
        ...
        statTotalSinkExceptions = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + SINK_EXCEPTIONS_TOTAL)
        ...
        statTotalSourceExceptions = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + SOURCE_EXCEPTIONS_TOTAL)
        ...
        statTotalWritten = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + WRITTEN_TOTAL)
        ...
        statlastInvocation = Gauge.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + LAST_INVOCATION)
        ...
        statTotalProcessedSuccessfully1min = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + PROCESSED_SUCCESSFULLY_TOTAL_1min)
        ...
        statTotalRecordsReceived1min = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + RECEIVED_TOTAL_1min)
        ...
        statTotalSysExceptions1min = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + SYSTEM_EXCEPTIONS_TOTAL_1min)
        ...
        statTotalSinkExceptions1min = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + SINK_EXCEPTIONS_TOTAL_1min)
        ...
        statTotalSourceExceptions1min = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + SOURCE_EXCEPTIONS_TOTAL_1min)
        ...
        statTotalWritten1min = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + WRITTEN_TOTAL_1min)
        ...
        sysExceptions = Gauge.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + "system_exception")
                .labelNames(exceptionMetricsLabelNames)
                .help("Exception from system code.")
                .register(collectorRegistry);

        userExceptions = Gauge.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + "user_exception")
                .labelNames(exceptionMetricsLabelNames)
                .help("Exception from user code.")
                .register(collectorRegistry);

        sinkExceptions = Gauge.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + "sink_exception")
                .labelNames(exceptionMetricsLabelNames)
                .help("Exception from sink.")
                .register(collectorRegistry);

        sourceExceptions = Gauge.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + "source_exception")
                .labelNames(exceptionMetricsLabelNames)
                .help("Exception from source.")
                .register(collectorRegistry);

        statTotalUserExceptions1min = Counter.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + USER_EXCEPTIONS_TOTAL_1min)
        ...
        statProcessLatency1min = Summary.build()
                .name(PULSAR_TRANSPORT_METRICS_PREFIX + PROCESS_LATENCY_MS_1min)
