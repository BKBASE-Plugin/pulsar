...
@PowerMockIgnore({"javax.management.*", "javax.ws.*", "org.apache.logging.log4j.*", "javax.xml.*", "org.xml.*",
        "org.w3c.dom.*", "org.springframework.context.*", "org.apache.log4j.*", "com.sun.org.apache.xerces.*",
        "javax.management.*"})
public class TransportConfigUtilsTest extends PowerMockTestCase {
    ...
    public void testConvertBackFidelity() throws IOException {
        ...
        inputSpecs.put("test-input",
                ConsumerConfig.builder().isRegexPattern(true).receiverQueueSize(532).serdeClassName("test-serde")
                        .build());
        ...
        Function.FunctionDetails functionDetails = TransportConfigUtils
                .convert(transportConfig, new TransportConfigUtils.ExtractedTransportDetails(null, null, null, null,
                        null));
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Transport Names "
            + "differ")
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Processing "
            + "Guarantees cannot be altered")
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "Retain Ordering "
            + "cannot be altered")
    ...
    @Test(expectedExceptions = IllegalArgumentException.class, expectedExceptionsMessageRegExp = "AutoAck cannot be "
            + "altered")
