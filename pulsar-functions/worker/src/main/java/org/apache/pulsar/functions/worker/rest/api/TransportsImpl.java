...
@Slf4j
public class TransportsImpl extends ComponentImpl implements Transports<PulsarWorkerService> {

    public TransportsImpl(Supplier<PulsarWorkerService> workerServiceSupplier) {
    ...
    @Override
    public void updateTransport(String tenant, String namespace, String transportName,
            InputStream uploadedInputStream, FormDataContentDisposition fileDetail,
            String transportPkgUrl, TransportConfig transportConfig, String clientRole,
    ...
    private Function.FunctionDetails validateUpdateRequestParams(final String tenant,
        ...
        // check if transport is builtin and extract classloader
        ...
        if (classLoader == null && transportPackageFile != null) {
            classLoader = getClassLoaderFromPackage(transportConfig.getSinkClassName(),
        ...
        TransportConfigUtils.ExtractedTransportDetails sourceDetails =
                TransportConfigUtils.validateAndExtractDetails(transportConfig, classLoader, worker().getWorkerConfig().getValidateConnectorConfig());
